...
//Se importa dart convert este covierte el archivo json
import 'dart:convert';
...
import 'package:read_json_file/archivos/ProductDataModel.dart';
//es la hoja donde llegan los productos
import 'package:read_json_file/archivos/carritoCompras.dart' show Cart;
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void productoAgregado() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Producto En Canasta'),
  ...
  void quitarProducto() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
          content: Text('Producto a Seleccionar'),
          duration: Duration(seconds: 1)
      ),
    );
  }
